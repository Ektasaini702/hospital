...
protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            PreparedStatement p1= c1.prepareStatement("select * from feedback where Date=?");
            p1.setString(1,d);
...
"            display: inline-block;\n"+" }\n"+"</style>");
                ...
                out.println(" <h1 style=\"background-color:DodgerBlue;\" align=\"center\"> Form to View Feedbacks</h1>\n" +"");
            while(rs.next())
            {   
