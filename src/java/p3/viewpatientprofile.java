...
@WebServlet(name = "viewpatientprofile", urlPatterns = {"/viewpatientprofile"})
public class viewpatientprofile extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            PreparedStatement p1= c1.prepareStatement("select * from patient where Patient_id=? and Name=?");
            p1.setString(1,id);
            p1.setString(2,na);
